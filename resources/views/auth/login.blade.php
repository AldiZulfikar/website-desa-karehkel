...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="{{asset('admin-assets') }}/assets/css/material-dashboard.css?v=3.0.0" rel="stylesheet" />
</head>
...
<body class="bg-gray-200">
              ...
              <div class="card-body">
                <form role="form" class="text-start" method="POST" action="{{ route('login') }}">
                  ...
                  <div class="input-group input-group-outline my-3">
                    <label class="form-label">{{ __('Masukan Alamat Email') }}</label>
                ...
                <div class="input-group input-group-outline mb-3">
                    <label class="form-label">{{ __('Masukan Password') }}</label>
  ...
  <script src="{{asset('admin-assets') }}/assets/js/material-dashboard.min.js?v=3.0.0"></script>
</body>
