          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Tabel Struktur PKK Desa</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
            <div class="col-12 text-end pb-4">
                <a class="btn bg-gradient-primary mb-0" href="{{route('admin-tambah-struktur-pkk-desa')}}"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Tambah Pengurus Desa</a>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  @foreach ($struktur as $item => $data)
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <a href="/desa/struktur-pkk/{{$data->id}}" class="badge badge-sm bg-gradient-success" data-toggle="tooltip" data-original-title="Edit user">
                          Ubah
                        </a>
                        <form onsubmit="return confirm('apakah kamu yakin ingin menghapus pengurus ini?')" action="{{route('admin-struktur-pkk-desa-delete', $data->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('delete')
